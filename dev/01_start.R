...
golem::fill_desc(
  pkg_name = "Tarot", # The Name of the package containing the App 
  pkg_title = "Tarot", # The Title of the package containing the App 
  pkg_description = "Compteur de point au tarot", # The Description of the package containing the App 
  author_first_name = "Alexandre", # Your First Name
  author_last_name = "Conanec",  # Your Last Name
  author_email = "alexandreconanec@gmail.com",      # Your Email
